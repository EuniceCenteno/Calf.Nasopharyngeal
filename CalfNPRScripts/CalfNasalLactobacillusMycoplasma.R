...
ggplot(mycoH, aes(x = d, y = taxa.average, fill =Species)) + 
...
ggplot(lactoH, aes(x = d, y = taxa.average, fill =Species)) + 
  geom_bar(stat = "identity") +
  theme_bw()+
  scale_fill_manual(values = my_colors) +
  ylim(c(0,0.3)) +
...
ggplot(mycoAD, aes(x = d, y = taxa.average, fill =Species)) + 
  geom_bar(stat = "identity") +
  theme_bw()+
  scale_fill_manual(values = my_colors) +
  ylim(c(0,0.3)) +
...
ggplot(lactoH1, aes(x = d, y = taxa.average, fill =Species)) + 
  geom_bar(stat = "identity") +
  theme_bw()+
  scale_fill_manual(values = my_colors) +
  ylim(c(0,0.3)) +
...
ggplot(lactoD1, aes(x = d, y = taxa.average, fill =Species)) + 
  geom_bar(stat = "identity") +
  theme_bw()+
  scale_fill_manual(values = my_colors) +
  ylim(c(0,0.3)) +
...
ggplot(lactoN1, aes(x = d, y = taxa.average, fill =Species)) + 
  geom_bar(stat = "identity") +
  theme_bw()+
  scale_fill_manual(values = my_colors) +
  ylim(c(0,0.3)) +
